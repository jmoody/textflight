...
for outfit in outfittype.outfits.values():
	...
	print_prop(outfit, "Increases attack by %d per crew member.", "attack")
	print_prop(outfit, "Houses %d colonists.", "crew")
	print_prop(outfit, "Increases defence by %d per crew member.", "defence")
