...
class USAGE:
	...
	JETTISON = "Usage: jettison <count> <cargo>"
	...
	INSTALL = "Usage: install <cargo>"
	LOAD = "Usage: load <count> <structure ID> <cargo>"
	SET = "Usage: set <setting> <outfit>"
	SUPPLY = "Usage: supply <energy> [structure ID]"
	SWAP = "Usage: swap <outfit ID> <outfit ID>"
	UNINSTALL = "Usage: uninstall <outfit>"
...
class CRAFT:
	...
	NOT_BASE = "Only bases can be expanded."
	EXPANDED = "Expanded base '{id} {name}' to {size} outfit space."
	JETTISONED = "Jettisoned {count} '{type}' from cargo."
	QUEUE_NEVER = "never"
...
class INFO:
	...
	LINKS = "Links:"
	LINK_NAMED = "\t[{index}] {name} (faction: {faction}) drag: {link_drag}"
	LINK_CLAIMED = "\t[{index}] (faction: {faction}) drag: {link_drag}"
	LINK = "\t[{index}] drag: {link_drag}"
	PLANETS = "Planets:"
