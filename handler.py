...
COMMANDS = {
	...
	"cancel": ("Cancels a queued assembly. Yields no resources.", craft_handler.handle_cancel),
	"construct": ("Constructs a new structure.", craft_handler.handle_construct),
	...
	"rename": ("Rename structure.", info_handler.handle_rename),
